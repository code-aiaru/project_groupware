// 파일 선택 시 이미지 미리보기 함수
 ...
 function validateBirth() {
     var birth = document.getElementById('studentBirthSpan').textContent;
...
function isDefaultImage() {
  ...
  return imageUrl.endsWith('/studentImages/default.png');
}
...
function loadDefaultImage() {
  var imagePreview = document.getElementById('preview-image1');
  imagePreview.src = '/studentImages/default.png';
}
